        ...
        child: Column(
          ...
          children: <Widget>[
            avatarSvg.isNotEmpty
                ? Container(
                    width: 100, // Atur lebar gambar sesuai yang Anda inginkan
                    height: 100, // Atur tinggi gambar sesuai yang Anda inginkan
                    child: SvgPicture.string(
                      avatarSvg,
                      // Atribut viewBox yang ditambahkan di sini
                      // Sesuaikan dengan nilai viewBox yang diinginkan
                      fit: BoxFit.contain,
